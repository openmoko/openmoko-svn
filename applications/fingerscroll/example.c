...
main (int argc, char **argv)
{
  ...
  GtkWidget *box, *hbox, *toolbar, *details, *navigation, *w, *scroll;
  ...
  for (i = 0; i < 100; i++)
  {
    gchar *text = g_strdup_printf ("This is row %d", i+1);
    gtk_list_store_insert_with_values (liststore, &it, i, 0, text, -1);
    g_free (text);
  }
