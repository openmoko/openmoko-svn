...
/* BOOLEAN:POINTER,POINTER (/tmp/dbus-binding-tool-c-marshallers.H9MZTT:1) */
...
/* BOOLEAN:STRING,POINTER (/tmp/dbus-binding-tool-c-marshallers.H9MZTT:2) */
...
/* BOOLEAN:POINTER (/tmp/dbus-binding-tool-c-marshallers.H9MZTT:3) */
