...
#define FONT_DESC             "Sans bold 18px"
#define FONT_TITLE_DESC       "Sans bold 38px"
#define FONT_TITLE_PATH_DESC  "Sans bold 28px"
...
#define POPUP_MENU_1				"Excute Application"
#define POPUP_MENU_2				"Add To Lanuch"
#define POPUP_MENU_3				"Remove From Lanuch"
...
typedef struct _mbdesktop {
  ...
  char *folder_img_path;
	...
	/* Added By Steven For Popup menu */
	Time                    click_time;
	Bool                    popup_mode;
	int 										hisapp_mode;
	Bool 										wheel_mode;
	...
	MBPixbufImage *img_popmenu;
	int           pop_x;
	int           pop_y;
	
	MBDesktopItem           *current_popup_item;
	
	MBPixbufImage *img_hisapp;
	MBPixbufImage *img_hisapp_hot;
	MBPixbufImage *img_hisapp1;
	MBPixbufImage *img_hisapp2;
	MBPixbufImage *img_hisapp3;
	MBPixbufImage *img_hisapp4;
	
	MBPixbufImage *img_title_bar;
	
	MBPixbufImage *img_back_hot;
	MBPixbufImage *img_back_dis;
	
	MBPixbufImage *img_scroll;
	MBPixbufImage *img_scroll_hot;
	
	MBPixbufImage *img_item_hot;
